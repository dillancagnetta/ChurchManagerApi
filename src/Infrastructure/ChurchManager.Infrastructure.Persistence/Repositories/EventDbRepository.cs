            ...
            .Select(x => new EventViewModel
            {
               Id = x.Id,
                ...
                Sessions = x.Sessions != null && x.Sessions.Any() ? x.Sessions.Select(x => new EventSessionViewModel
                {
                    ...
                    StartTime = x.SessionStartDateTime().StartTime.HasValue ? x.SessionStartDateTime().StartTime!.Value : null,
                    EndDate = x.SessionEndDateTime().EndDate,
                    EndTime = x.SessionEndDateTime().EndTime.HasValue ? x.SessionEndDateTime().EndTime!.Value : null,
                    Location = x.Location,
